...
public class VentanaPerfil extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(estado, javax.swing.GroupLayout.DEFAULT_SIZE, 471, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(avatar, javax.swing.GroupLayout.DEFAULT_SIZE, 254, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jPanel10, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
        );
    ...
    private void inicioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_inicioActionPerformed
        boolean sinCambios = ((ImagePanelSelector)avatar).getDir().equals(perfil.getAvatar()) &&
                          ((ImagePanelSelector)portada).getDir().equals(perfil.getPortada()) &&
                          ((ImagePanelSelector)icono).getDir().equals(perfil.getIcono()) &&
                          colegio.getText().equals(perfil.getColegio()) && 
                          estado.getText().equals(perfil.getEstado()) &&
                          religion.getText().equals(perfil.getReligion()) &&
                          trabajo.getText().equals(perfil.getTrabajo()) &&
                          universidad.getText().equals(perfil.getUniversidad());
                          
        if(sinCambios){
            new VentanaInicio(usser).setVisible(true);
            dispose();
        }else{ 
            int resultado = JOptionPane.showConfirmDialog(null,"Usted hizo cambios en su perfil\n ¿ Desea Guardarlos ?","Cambios no guardados",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        guardar();
        JOptionPane.showMessageDialog(null, "Se actualizo el Perfil correctamente ");
    ...
    private void llenarCampos() {
        ...
        for (Contacto contacto : contactos) {
            ContactoVista con = new ContactoVista(contacto,usser);
            con.eliminable();
            amigos.add(con);   
        }
